    ...
    return (
      <main className={styles.main}>
        ...
        <p>
          ...
          when others import or sync their contacts with our Services, associate
          their contacts with Member profiles, or send messages using our
          Services (including invites or connection requests).
        </p>
        <h3>Use of Data</h3>
        ...
        <ul>
          <li>By email: support@goalmogul.com</li>
        </ul>
      </main>
    )
  }
