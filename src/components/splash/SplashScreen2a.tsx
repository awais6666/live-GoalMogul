...
import iosButton from "../../assets/ios.png"
import AndroidButton from "../../assets/pl.png"
...
import reviewimage from './../../assets/Group 2258.png'
import reviewimage2 from './../../assets/John_.png'
import reviewimage3 from './../../assets/bob-proctor.jpg'
import playstore from './../../assets/Google-Play.png'
import chamber from './../../assets/chamber.png'
import appstore from './../../assets/app-store.svg'
import JaLogo from './../../assets/JA-Logo.png'
import pgiLogo from './../../assets/PGI-Logo-300-169.png'
import mvhLogo from './../../assets/mvh-logo.png'
 ...
 */
export default class SplashScreen2a extends React.Component<PropsInterface> {
  state = {
    hasInviteCode: false,
    inviter: {
      firstName: "",
  ...
  */
  ...
  render() {
    ...
    return (
      <div id="whiteVersion" className={styles.v2a}>
        ...
        <main className={styles.splashMain}>
                ...
                <div className={styles.inputDiv}>
                  ...
                  >
                    <p className='appLaunching'>
                      Set goals like a boss <br /> Pick who you want to share them with <br /> Help each other and 10x the quality of your friendship
                  </p>
                    <h4>Get It Now</h4>
          ...
          <div className={styles.chamber}>
            ...
            <img src={chamber} />
            <p className={styles.endrosedText}>Endorsed By:</p>
            <div className={styles.endroseDiv}>
              <div className={styles.endroseLogoDiv}>
                <img src={JaLogo} />
                <img src={pgiLogo} />
                <img src={mvhLogo} />
              </div>
          ...
          <section className={styles.reviewSec}>
            <div className={styles.reviewDiv}>
              <div className={styles.reviewImageDiv}>
                <div className={styles.image} style={{ backgroundImage: `url(${reviewimage})` }}> </div>
              </div>
              {this.starSvg(5)}
              <p>
              ...
              <p className={styles.introBr}>-Mark Victor Hansen (59x NY Times #1 Bestselling Author, 500 Million Books Sold, Co-Creator of Chicken Soup Series)</p>
            </div>
          </section>
          ...
          <section className={styles.reviewSec}>
            <div className={styles.reviewDiv}>
              ...
              {this.starSvg(5)}
              <p>
                “Sharing goals with friends has been one of my life’s greatest keys to success. When I met Jack Canfield and found out we had the same goals, we partnered up and eventually sold 500 million books together. If you have unrealized dreams and goals, then take a leap of faith and share them with the world. This little known trick will help you manifest and materialize your desires. GoalMogul has brilliantly laid out a path that will nurture your mind for success. Follow it and watch your dreams unfold and your relationships blossom.”
                </p>
              <p className={styles.introBr}>-Mark Victor Hansen (59x NY Times #1 Bestselling Author, 500 Million Books Sold, Co-Creator of Chicken Soup Series)</p>
            </div>
          </section>
          ...
          <section className={styles.reviewSec}>
            <div className={styles.reviewDiv}>
              <div className={styles.reviewImageDiv}>
                <div className={styles.image} style={{ backgroundImage: `url(${reviewimage2})` }}> </div>
              </div>
              {this.starSvg(5)}
              <p>
                “Sharing goals with friends has been one of my life’s greatest keys to success. When I met Jack Canfield and found out we had the same goals, we partnered up and eventually sold 500 million books together. If you have unrealized dreams and goals, then take a leap of faith and share them with the world. This little known trick will help you manifest and materialize your desires. GoalMogul has brilliantly laid out a path that will nurture your mind for success. Follow it and watch your dreams unfold and your relationships blossom.”
          ...
          <section className={styles.reviewSec}>
            <div className={styles.reviewDiv}>
              <div className={styles.reviewImageDiv}>
                <div className={styles.image} style={{ backgroundImage: `url(${reviewimage3})` }}> </div>
              </div>
              {this.starSvg(5)}
              <p>
              ...
              <p className={styles.introBr}>-Bob Proctor, Featured Teacher in 'The Secret' and Bestselling Author of 'You Were Born Rich'</p>
          ...
          <section className={styles.sectionEight}>
            <div className={styles.sectionContent}>
              ...
              <div className={styles.textWrapper}>
                <p>
                  Don't think. Don't wonder. Just try it.
                  <br />
                  <b>Download Now.</b>
                </p>
                ...
                {/* <div className={styles.DownloadNowHead}>
                  <h3>Download Now</h3>
                </div> */}
