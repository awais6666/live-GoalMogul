 ...
 */
export default class SplashScreen1c extends React.Component<PropsInterface> {
  state = {
    hasInviteCode: false,
    inviter: {
      firstName: "",
        ...
        <main className={styles.splashMain}>
          ...
          <section className={styles.sectionOne}>
            <div className={styles.sectionContent}>
              ...
              <h1 className={styles.hideInMobV1c}>
                Grow closer to your friends than ever before...
              {/* </Typist> */}
              </h1>
              {/* <Typist.Delay ms={500} /> */}
              <h2 className={styles.hideInMobV1c}>
              ...
              <div className={styles.textWrapper}>
                <div className={styles.inputDiv}>
                  <ScrollAnimation
                    ...
                    delay={400}
                  >
                    <p className={styles.hideInMobV1c}>
                      Do the most important thing in a friendship... <br /> Help
                    each other grow
                    <br />
                    </p>
