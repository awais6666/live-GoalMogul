...
export default class SplashScrenV7 extends React.Component<PropsInterface> {
    state = {
        hasInviteCode: false,
        inviter: {
            firstName: "",
    ...
    */
    ...
    uniqueSliderHeadings = (i: number) => {
        ...
        if (i === 0) {
            ...
            p1 = "Spread H.O.P.E:"
            p2 = "Help Other People Everyday"
            p3 = ""
        } else if (i === 2) {
            heading = "KEEP A PULSE ON WHAT THEY NEED IN LIFE"
            p1 = "Pay it forward with one tap... in just a few minutes a day."
            p2 = ""
            p3 = ""
        } else if (i === 3) {
            heading = "HELPING FRIENDS JUST GOT EASIER"
            p1 = "Swipe left for video or voice comments"
            p2 = "Give encouragement, motivation,"
            p3 = "referrals, or advice"
        } else if (i === 4) {
            heading = "DREAM-STRETCHING GOAL PLANNER"
            ...
            heading = "MASTERMIND, HOLD EACH OTHER TO IT"
                ...
                <div className={styles.v5MainInner}>
                    ...
                    <div className="uniqueAppSec">
                        <div className="innerUniqueSec">
                            ...
                            <div className="uniqueText">
                                <h2>{this.state.uniqueText.heading}</h2>
                                <p>{this.state.uniqueText.p1}
                                    {this.state.uniqueText.p2 ? <>
                                        <br /> {this.state.uniqueText.p2}
                                    </> : ''}
                                    {this.state.uniqueText.p3 ? <> <br className="hidePc" />{this.state.uniqueText.p3}  </> : ''} <br className="hidePc" /> <br className="hidePc" />  </p>
                            </div>
                            {/* <div>
                            ...
                            <div className="uniqueAppSlider">
                                ...
                                {/* @ts-ignore */}
                                <Slider ref={slider => (this.uniqueSlider = slider)}  {...settingsWireFrame} >
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp1} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'none' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp2} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'none' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp3} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'none' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp4} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'none' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp5} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'none' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp6} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'none' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp7} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'none' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                    <div className="wireframeDiv">
                                        <div className="wireframe">
                                            <img src={uniqueApp8} className="backMask" style={this.state.translateZ ? { transform: this.state.translateZ } : { transform: 'translateZ(0)' }} />
                                            <img src={maskgroup} className="maskImage hidePc" />
                                        </div>
                                    </div>
                                </Slider>
                    ...
                    <div className="backgroundWhite">
                        <div className="sectionFourth">
                            ...
                            <div className="wireframeText">
                                ...
                                <div className="textWire">
                                    <h2>Think Big and Kick Ass with
                                        <br className="hideMob" /> the
                            ...
                            <div className="wireframeText wireframeText3 colRev ">
                                <div className="textWire">
                                    <h2>Your Future <br className={styles.hideMob} />  in Your Hands, with <br className={styles.hideMob} />  Your Friends to Support You</h2>
                                    <p>Break big goals into small steps <br />
                                        Prioritize, categorize, set deadlines<br />
                                        Get reminders and motivation
                                    </p>
                                </div>
                                    ...
                                    <div className="innerSlider">
                                        <div id="slide1" className="slide leftImage active" onClick={(ev) => this.changeSlide(ev.currentTarget, 'slide1', 'slide1Nav')} >
                                            ...
                                            <div className="lottieDiv">
                                                ...
                                                <Lottie
                                                    options={this.state.defaultOptionsGoal}
                                                />
                                            </div>
                                        </div>
                    ...
                    <div className="footerV5">
                        <div className="innerFooter backgroundWhite">
                            ...
                            <h3 className={styles.v7ComingSoonFooter}>COMING SOON</h3>
